...
// Special Keys
var (
	KeyEsc        = defineKey(glfw.KeyEsc, "Esc")
	...
	KeyLshift     = defineKey(glfw.KeyLshift, "Lshift")
	KeyRshift     = defineKey(glfw.KeyRshift, "Rshift")
	KeyLctrl      = defineKey(glfw.KeyLctrl, "Lctrl")
	KeyRctrl      = defineKey(glfw.KeyRctrl, "Rctrl")
	KeyLalt       = defineKey(glfw.KeyLalt, "Lalt")
	KeyRalt       = defineKey(glfw.KeyRalt, "Ralt")
	...
	KeyDel        = defineKey(glfw.KeyDel, "Del")
	...
	KeyKPNumlock  = defineKey(glfw.KeyKPNumlock, "KPNumlock")
	...
	KeyLsuper     = defineKey(glfw.KeyLsuper, "Lsuper")
	KeyRsuper     = defineKey(glfw.KeyRsuper, "Rsuper")
...
func defineKey(keyCode int, keyName string) KeyCode {
